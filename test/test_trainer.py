...
def test_train_Unet_valeria(n_epochs=10,valid_each=1,train_batch_size=32,test_batch_size=32, ratio_data=100, n_time_steps = n_steps, learning_rate=2e-4, dropout=None, n_conv_filters=64):
